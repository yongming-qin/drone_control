...
void YoloObjectDetector::init()
{
  ...
  message_filters::Subscriber<sensor_msgs::Image> imageSubscriber(imageTransport_, cameraTopicName, cameraQueueSize);
...
void YoloObjectDetector::callback(const sensor_msgs::ImageConstPtr& image, const sensor_msgs::PointCloud2ConstPtr& pc)
{
